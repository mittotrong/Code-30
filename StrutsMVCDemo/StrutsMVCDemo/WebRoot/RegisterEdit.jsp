...
<html:html lang="true">
  <head>
	...
	<script type="text/javascript">
			function editCancle()
			{
				...
				document.forms[0].action="./personList.do";
  ...
  <body>
   ...
   <br/><br/><br/><br/><br/><br/><br/>
    	...
    	%>
    		<tr>
    			<td> <html:hidden name="personBean" property="pid"/> </td>
    		...
    		<tr>
    			...
    			<td width="134"  align="right"></td>
   			  	<td width="105"  > <html:submit value="    OK    " ></html:submit>
   			  	<html:reset onclick="javascript:editCancle()" value="  Cancel  " ></html:reset>
   			  	</td>
   			  	<td width="137">   </td>
    			<td width="104"></td>
    		</tr>
